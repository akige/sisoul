...
The directory URL defaults to SISOUL_PREKEY_DIRECTORY env var, falling back
to the maintainer-hosted public instance. Users can run their own directory and
point clients at it via env.
"""
